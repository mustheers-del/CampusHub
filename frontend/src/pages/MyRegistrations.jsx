...
export default function MyRegistrations() {
  ...
  const handleCancelRegistration = async () => {
    ...
    try {
      ...
      showNotification(
        `Successfully cancelled registration for "${deletingTitle}"!`
      );
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <p className="empty-desc">
            Head over to the Browse Events page to enroll in upcoming
            activities!
          </p>
        </div>
      ) : (
            ...
            >
              ...
              {reg.registration_type === 'Group' && (
                ...
                >
                  ...
                  >
                    👥 Team Name: "{reg.group_name}" (
                    {reg.group_size} Team Members)
                  </div>
