...
export default function EventDetails() {
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      showNotification(
        'Event PDF Report downloaded successfully!'
      );
    } catch (err) {
      showNotification(
        err.message || 'Failed to generate Event PDF.',
        'error'
      );
    } finally {
  ...
  const handleDeleteRegistrationConfirm = async () => {
    ...
    try {
      ...
      showNotification(
        `Registration for "${deletingStudentName}" removed successfully!`
      );
      ...
      showNotification(
        err.message || 'Failed to remove registration.',
        'error'
      );
    } finally {
      setIsSubmitting(false);
    ...
    <div>
      ...
      <div className="card">
        ...
        >
          <div>
            ...
            >
              <span className="category-badge cat-technical">
                {category}
              </span>
        ...
        >
          ...
          >
            <span>
              Total Capacity: {cap} Seats
            </span>

            <span>
              {isFull
                ? '🚫 Registrations Closed'
                : `✅ ${remSeats} seats remaining`}
            </span>
          </div>
        </div>
      </div>
                    ...
                    <tr key={reg.id}>
                      ...
                      <td>
                        ...
                        'Group' ? (
                          ...
                          >
                            <span className="category-badge cat-cultural">
                              👥 Team:{' '}
                              {reg.group_name}
                            </span>
      ...
      {deletingRegId && (
        <ConfirmModal
          ...
          isDeleting={isSubmitting}
          onConfirm={
            handleDeleteRegistrationConfirm
          }
          onCancel={() =>
            setDeletingRegId(null)
          }
